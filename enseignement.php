...
<html lang="fr-FR">
	...
	<body>
		...
		<div class="container presentation-block">
			...
			<div class="row justify-content-center team-block">
				...
				<div class="team-block-img order-2 order-lg-2">
					...
					<a href="la-team.php" class="btn btn-dark">RENCONTREZ NOTRE TEAM</a>
			...
			<div  class="container hatha-block">
				...
				<div class="row align-items-center">
					...
					<div class="col text-center order-2">
						...
						<a href="planning.php" class="btn btn-primary shadow-none">CONSULTEZ LE PLANNING</a>
		...
		<div class="container text-center lien-tarifs">
			...
			<p>Vous pouvez consulter nos tarifs <a href="tarifs.php">ici</a>.</p>
