...
<footer>
	...
	<div class="container">
		...
		<div class="row justify-content-center footer-line1">
			...
			&copy; <?php echo date("Y"); ?> Zentopia. Tous droits réservés
		...
		<div class="row justify-content-center footer-line3">
			...
			<ul class="nav footer-main-links text-center">
				...
				<li class="nav-item col-12 col-md"><a href="plan-du-site.php">PLAN DU SITE</a></li>
				<li class="nav-item col-12 col-md"><a href="reglement-interieur.php">RÈGLEMENT INTÉRIEUR</a></li>
				<li class="nav-item col-12 col-md"><a href="mentions-legales.php">MENTIONS LEGALES</a></li>
