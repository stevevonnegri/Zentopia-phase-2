	...
	<form class="block-coordonnees" action="?action=espace_personnel&form=active" method="POST">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				...
				<input type="radio" name="genre" id="femme" value="Femme" required {if $_SESSION.genre == Femme}checked{/if}>
				<label for="femme">Mme</label>

				<input type="radio" name="genre" id="homme" value="Homme" {if $_SESSION.genre == Homme}checked{/if}>
