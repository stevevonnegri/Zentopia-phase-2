    ...
    if($image->count() >= 10) {
        ...
        if($_SESSION['rang'] == 'admin' || $_SESSION['rang'] == 'moderateur'){
            ...
            if($_FILES['image']['error'] == 0){
                ...
                // déplace l'image du dossier temp, puis redimensionne l'image en 770px de largeur
                ...
                if(!$resultat){
                    ...
                    // vérifie qu'il n'y a pas eu d'erreur lors du déplacement de l'image
                ...
                if($tailleImage['1'] <= 550 && $tailleImage['1'] >= 450 && $tailleImage['0'] < 780 ) {
                    ...
                    // crée une erreur pour la taille puis supprime les fichiers du serveur
